...
export default function Home() {
  return (
    <main className="bg-slate-950 min-h-screen text-slate-200 selection:bg-cyan-500/30 font-sans">
      ...
      {/* 1. HERO SECTION */}
      {/* <section className="pt-36 pb-20 px-6 max-w-6xl mx-auto" id="about">
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
        >
          <p className="text-cyan-400 font-mono mb-4 tracking-wide">Hi, my name is</p>
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-4 tracking-tight">Shane Alam.</h1>
          ...
          <div className="bg-gradient-to-r from-slate-900 to-slate-900/50 border border-slate-800 rounded-2xl p-8 mb-10 max-w-3xl shadow-xl shadow-black/20">
             ...
             <div className="grid gap-4">
                {aboutText.highlights.map((highlight, index) => (
                    <div key={index} className="flex items-start gap-4 text-slate-300 group">
                        <div className="mt-1.5 min-w-[16px] text-cyan-500/50 group-hover:text-cyan-400 transition-colors">
          ...
          <div className="flex flex-wrap gap-4">
            <a href="#projects" className="px-8 py-4 bg-cyan-500 text-slate-950 font-bold rounded-lg hover:bg-cyan-400 transition shadow-lg shadow-cyan-500/20">Check my work</a>
            <div className="flex gap-4 items-center px-4">
              <Link href="https://github.com/shane6123" target="_blank"><Github className="text-slate-400 hover:text-cyan-400 transition cursor-pointer" size={24} /></Link>
              <Link href="https://www.linkedin.com/in/shanealam/" target="_blank"><Linkedin className="text-slate-400 hover:text-cyan-400 transition cursor-pointer" size={24} /></Link>
              <a href="mailto:shanealam6123@gmail.com"><Mail className="text-slate-400 hover:text-cyan-400 transition cursor-pointer" size={24} /></a>
            </div>
          </div>
        </motion.div>
      </section> */}
       {/* <section className="pt-32 pb-20 px-6 max-w-6xl mx-auto" id="about">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-bold text-slate-400 mb-8">I build scalable backend architectures.</h2>
          <p className="max-w-2xl text-slate-400 text-lg leading-relaxed mb-8">
            ...
            <span className="text-cyan-400"> Next.js, NestJS, and AWS.</span>
          </p>
